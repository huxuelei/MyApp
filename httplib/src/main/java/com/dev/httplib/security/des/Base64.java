...
import com.dev.httplib.security.encoder.BASE64Decoder;
import com.dev.httplib.security.encoder.BASE64Encoder;

/**
 * This was grabbed off of the web. It is supposed to be open source.
 * <p/>
 * Encodes and decodes to and from Base64 notation. I modified it to use
 * different characters that are more URL friendly. In particular, i used '_'
 * instead of '+', '-' instead of '/', and '.' instead of '='. Note that the
 * characters chosen were so that we would not need to URLEncode them.
 * <p/>
 * -gil.
 * *************************************************************************
 * <p/>
...
public class Base64 {
	 ...
	 * 
	 * @ReqParam threeBytes the array to convert
	 ...
	 * 
	 * @ReqParam threeBytes the array to convert
	 * @ReqParam numSigBytes the number of significant bytes in your array
	 * @return four byte array in Base64 notation.
	 * @since 1.3
	 */
	 ...
	 * 
	 * @ReqParam b4 A reusable byte array to reduce array instantiation
	 * @ReqParam threeBytes the array to convert
	 * @ReqParam numSigBytes the number of significant bytes in your array
	 * @return four byte array in Base64 notation.
	 * @since 1.5.1
	 ...
	 * <var>numSigBytes</var>.
	 * 
	 * @ReqParam source the array to convert
	 * @ReqParam srcOffset the index where conversion begins
	 * @ReqParam numSigBytes the number of significant bytes in your array
	 * @ReqParam destination the array to hold the conversion
	 * @ReqParam destOffset the index where output will be put
	 ...
	 * 
	 * @ReqParam serializableObject The object to encode
	 ...
	 * 
	 * @ReqParam source The data to convert
	 * @since 1.4
	 */
	 ...
	 * 
	 * @ReqParam source The data to convert
	 * @ReqParam options Specified options
	 * @since 2.0
	 */
	 ...
	 * 
	 * @ReqParam source The data to convert
	 * @ReqParam off Offset in array where conversion should begin
	 * @ReqParam len Length of data to convert
	 * @since 1.4
	 */
	 ...
	 * 
	 * @ReqParam fourBytes the array with Base64 content
	...
	private static int decode4to3(byte[] source, int srcOffset, byte[] destination, int destOffset) {
		...
		// Example: DkLE
			...
			try {
				...
				Log.i("=====","" + source[srcOffset] + ": " + (DECODABET[source[srcOffset]]));
				Log.i("=====","" + source[srcOffset + 1] + ": " + (DECODABET[source[srcOffset + 1]]));
				Log.i("=====","" + source[srcOffset + 2] + ": " + (DECODABET[source[srcOffset + 2]]));
				Log.i("=====","" + source[srcOffset + 3] + ": " + (DECODABET[source[srcOffset + 3]]));
				return -1;
			} //e nd catch
		}
	} // end decodeToBytes
	 ...
	 * features.
	 * 
	 * @ReqParam source The Base64 encoded data
	 * @ReqParam off The offset of where to begin decoding
	 * @ReqParam len The length of characters to decode
	 * @return decoded data
	 * @since 1.3
	 */
	 ...
	 * 
	 * @ReqParam s the string to decode
	 * @return the decoded data. Will return null if the passed in charaters are
	 *         bad, or 's' is null or empty.
	 * @since 1.4
	 */
	 ...
	 * 
	 * @ReqParam encodedObject The Base64 data to decode
	...
	public static class InputStream extends java.io.FilterInputStream {
		 ...
		 * 
		 * 
		 * @ReqParam in the {@link java.io.InputStream} from which to read data.
		 * @since 1.3
		 */
		 ...
		 * 
		 * @ReqParam dest array to hold values
		 * @ReqParam off offset for array
		 * @ReqParam len max number of bytes to read into array
	...
	public static class OutputStream extends java.io.FilterOutputStream {
		...
		/**
		 * 
		 * @ReqParam out the {@link java.io.OutputStream} to which data will be
		 *           written.
		 * @since 1.3
		 */
		 ...
		 * 
		 * @ReqParam theByte the byte to write
		 * @since 1.3
		 */
		 ...
		 * written.
		 * 
		 * @ReqParam theBytes array from which to read bytes
		 * @ReqParam off offset for array
		 * @ReqParam len max number of bytes to read into array
		 * @since 1.3
		 */
