...
import com.net.okhttp.toolsfinal.io.stream.ByteArrayOutputStream;
import com.net.okhttp.toolsfinal.io.stream.StringBuilderWriter;
...
public class IOUtils {
    ...
    public static void writeLines(Collection<?> lines, String lineEnding, OutputStream output, Charset encoding) throws IOException {
        if(lines != null) {
            ...
            for(Iterator i$ = lines.iterator(); i$.hasNext(); output.write(StringCodingUtils.getBytes(lineEnding, cs))) {
                Object line = i$.next();
                if(line != null) {
