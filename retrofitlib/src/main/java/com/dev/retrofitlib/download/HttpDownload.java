package com.dev.retrofitlib.download;
...
import com.dev.retrofitlib.download.core.DownHelper;
import com.dev.retrofitlib.download.core.DownService;
import com.dev.retrofitlib.download.core.DownTask;
...
import com.dev.retrofitlib.download.mode.DownRecord;
...
public class HttpDownload {
     ...
     * @return HttpDownload
     */
    public HttpDownload context(Context context) {
     ...
     * @return
     */
    public HttpDownload defaultSavePath(String savePath) {
     ...
     * @return
     */
    public HttpDownload retrofit(Retrofit retrofit) {
     ...
     * @return
     */
    public HttpDownload maxThread(int max) {
     ...
     * @return
     */
    public HttpDownload maxRetryCount(int max) {
     ...
     * @return
     */
    public HttpDownload maxDownloadNumber(int max) {
    ...
    public Observable<DownEvent> receiveDownProgress(final String url) {
        return Observable.create(new Observable.OnSubscribe<Object>() {
            ...
            public Observable<DownEvent> call(Object o) {
                return mDownService.getSubject(HttpDownload.this, url).asObservable().onBackpressureLatest();
            }
    ...
    public Observable<List<DownRecord>> getTotalDownloadRecords() {
        if (mContext == null) {
            return Observable.error(new Throwable("Context is NULL! You should call " +
                    "#HttpDownload.context(Context context)# first!"));
        }
    ...
    private void addDownloadTask(@NonNull String url, @NonNull String saveName,
        ...
        mDownService.addDownTask(
                new DownTask.Builder(HttpDownload.this)
                        .setUrl(url)
