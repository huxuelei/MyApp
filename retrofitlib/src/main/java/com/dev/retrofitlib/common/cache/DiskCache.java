package com.dev.retrofitlib.common.cache;
...
import com.dev.retrofitlib.common.cipher.MD5;
import com.dev.retrofitlib.common.utils.AppUtil;
...
public class DiskCache implements ICache {
    ...
    public DiskCache(Context context) {
        this(context, getDiskCacheDir(context, HttpConfig.CACHE_DISK_DIR),
                calculateDiskCacheSize(getDiskCacheDir(context, HttpConfig.CACHE_DISK_DIR)));
    }
